(function() {
    ...
    const PUNCH_BUTTON1 = "TL_LINK_WRK_TL_SAVE_PB$0"; // punch button element
    const PUNCH_BUTTON2 = "TL_LINK_WRK_TL_SAVE_PB$205$$0";
    ...
    iframe.onload = function () {
        ...
        watch(() => doc.getElementById(TIME_REPORTING_INPUT) != null, () => {
             ...
             */
            doc.getElementById(PUNCH_BUTTON1).parentNode.onmousedown = doc.getElementById(PUNCH_BUTTON2).parentNode.onmousedown = function () {
                /**
